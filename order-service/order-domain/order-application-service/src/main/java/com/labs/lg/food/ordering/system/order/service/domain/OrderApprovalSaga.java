...
public class OrderApprovalSaga implements SagaStep<RestaurantApprovalResponse> {
    ...
    public void process(RestaurantApprovalResponse restaurantApprovalResponse) {
        ...
        final OrderApprovalOutboxMessage orderApprovalOutboxMessage = approvalOutboxMessageResponse.get();

        // step 2: Start with logic business using the Domain Service

        final Order order = approveOrder(restaurantApprovalResponse);
    ...
    public void rollback(RestaurantApprovalResponse restaurantApprovalResponse) {
        ...
        // step 2: Start with logic business using the Domain Service
        final OrderCancelledEvent domainEvent = rollbackOrder(restaurantApprovalResponse);
    ...
    private OrderPaymentOutboxMessage getUpdatedPaymentOutboxMessage(String sagaId,
        ...
        final Optional<OrderPaymentOutboxMessage> paymentOutboxMessageResponse = paymentOutboxHelper
        ...
        final OrderPaymentOutboxMessage orderPaymentOutboxMessage = paymentOutboxMessageResponse.get();
    ...
    private OrderCancelledEvent rollbackOrder(RestaurantApprovalResponse restaurantApprovalResponse) {
        ...
        final OrderCancelledEvent domainEvent = orderDomainService
